            ...
            <div class="container">
                <div class="row">
                    <div class="col-12 mt-5">
                        <a href="{{ route('admin.planning.create') }}" class="btn btn-primary mb-3">Tambah Planning</a>
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Data Planning</h3>
                            </div>
                            <!-- /.card-header -->
                                    ...
                                    <tbody>
                                        @foreach ($planning as $p)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('admin.planning.edit', ['id' => $p->id]) }}" class="btn btn-primary">
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer justify-content-between">
                                                            <form action="{{ route('admin.planning.delete', ['id' => $p->id]) }}" method="POST">
                                                                @csrf
                                                                @method('DELETE')
