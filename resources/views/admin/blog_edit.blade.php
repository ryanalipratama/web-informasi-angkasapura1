                                ...
                                <form>
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="judul" name="judul" value="{{ old('judul', $blog->judul) }}">
                                            @error('judul')
                                                <small>{{ $message }}</small>
                                            @enderror
                                        </div>   
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" id="tanggal" name="tanggal" value="{{ old('tanggal', $blog->tanggal) }}">
                                            @error('tanggal')
                                                <small>{{ $message }}</small>
                                            @enderror
                                        </div>      
