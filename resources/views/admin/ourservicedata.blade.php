...
<!-- Main content -->
        <section class="content">
            <div class="container pt-5">
                <div class="row">
                    <div class="col-12">
                        <a href="{{ route('admin.ourservicedata.create') }}" class="btn btn-primary mb-3">Tambah Data Our Service</a>
                        <div class="card">
                            <div class="card-header">
                                <h3 class="card-title">Data Our Service</h3>
                            </div>
                            <!-- /.card-header -->
                                    ...
                                    <tbody>
                                        @foreach ($ourservicedata as $o)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($o->gambar)
                                                        <img src="{{ asset($o->gambar) }}"
                                                            style="max-width: 100px;">
                                                    @endif
                                                </td>

                                                <td>
                                                    <a href="{{ route('admin.ourservicedata.edit', ['id' => $o->id]) }}"
                                                        class="btn btn-primary"><i class="fas fa-pen"></i>Edit</a>
                                                    <a data-toggle="modal" data-target="#modal-hapus{{ $o->id }}"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer justify-content-between">
                                                            <form action="{{ route('admin.ourservicedata.delete', ['id' => $o->id]) }}" method="POST">
                                                                @csrf
                                                                @method('DELETE')
